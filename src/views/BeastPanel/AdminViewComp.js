...
import AdminSideNavLite from './comps/AdminSideNavLite'

const AdminViewComp = () => {
    const [screenWidth] = useState(window.innerWidth);
    return (
        <>
            <div className={`d-flex ${screenWidth<1000?'flex-column':'flex-row'} w-100`}>
                {
                    screenWidth < 1000 ? <AdminSideNavLite/> : <AdminSideNav />
                }
                <Routes>
