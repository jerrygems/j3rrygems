    ...
    return (
        <>
            <div className='d-flex flex-column text-start'>
                <h3 className='p-3'>ASBs Edit</h3>
                <form className='py-3 px-4 border rounded' >
                    <div className="form-group">
                        <label htmlFor="content"><h4>ASB Content:</h4></label>
                    ...
                    <button type="submit" className="btn btn-primary" /*onClick={updateASBs} */><i className='fa fa-refresh p-1'></i>Update</button>
                </form>
                <br></br>
                <div className='col'>
